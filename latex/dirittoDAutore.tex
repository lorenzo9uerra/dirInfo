...
\begin{itemize}
    ...
    tanto se in forma scritta qaunto se orale;
    \item I disegni e le opere dell'architettura;
    \item \textbf{I programmi per elaboratore}, in qualsiasi forma espressi
    purchè originali quale risultato di creazione intelletuale dell'autore.
...
una quota o una parte della proprietà intelletuale su una data opera a coloro
che contribuiscono in maniera signficativa al processo creativo, e da garantire
